...
class UI:
    ...
    def _criar_conta(self):
        print("Digite o nome de algum banco")
        for banco in Bancos:
            print(f'----{banco.value}-----')

        banco = input().title()
        valor = float(input("Digite o valor em conta"))
    ...
    def _desativar_conta(self):
        ...
        try:
            ...
            print("Essa conta ainda possui saldo, faça uma transferencia")

    def _transferir_saldo(self):
        print("Esoclha a conta retirar o dinheiro")
        for i in listar_contas():
            print(f'{i.id} -> {i.banco.value} -> R${i.valor}')
